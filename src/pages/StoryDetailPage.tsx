    ...
    subsections: [
      {
        ...
        content: `<p>Keikutsertaan dalam Adiwiyata dimulai pada tahun 2019, bertepatan dengan awal masa sekolah di MAN 1 Pandeglang. Pada tahap awal, kegiatan yang diikuti mencakup menjaga kebersihan lingkungan, menata taman, merawat tanaman, serta memastikan area halaman selalu rapi. Rutinitas seperti membersihkan kelas, memindahkan pot, memperbaiki sudut taman, hingga merapikan area yang rusak menjadi kegiatan harian. Selain itu, program seperti seleberih atau penilaian kelas bersih, hiking lingkungan, penghijauan kecil, pembuatan sudut hijau, dan kerja bakti besar sebelum acara sekolah juga menjadi bagian dari aktivitas organisasi ini.</p>
        <p>Banyak momen yang masih terasa jelas hingga kini, misalnya ketika taman sudah ditata sejak pagi namun hujan deras tiba-tiba menggagalkan seluruh kerja keras hari itu. Situasi tersebut tidak dapat dihindari, namun justru memperkuat rasa kebersamaan di dalam organisasi.</p>
        <p>Pada tahun 2021–2022, kepercayaan lebih besar diberikan melalui tugas sebagai Ketua Adiwiyata. Tanggung jawab meningkat mulai dari memastikan kesiapan lingkungan setiap pagi, mengatur pembagian tugas anggota, mengoordinasikan program, hingga mengawasi seluruh kegiatan rutin agar tidak ada area sekolah yang terlewat. Selain itu, perencanaan pengembangan taman, penambahan tanaman, serta pembuatan sudut hijau baru juga dilakukan untuk membuat lingkungan sekolah lebih hidup. Pengalaman memimpin organisasi ini memberikan banyak pelajaran mengenai keteladanan, pengambilan keputusan, dan pengelolaan anggota.</p>`,
      },
      {
        title: "OSIS (2021–2022)",
        content: `<p>Perjalanan di OSIS dimulai pada tahun 2021 dengan peran sebagai Kepala Bidang. Kegiatan OSIS memiliki ritme yang lebih dinamis karena program berlangsung hampir setiap bulan. Salah satu kegiatan terbesar adalah Class Meeting, yang melibatkan perlombaan seni dan olahraga. Persiapannya sering dipenuhi kejadian tak terduga, mulai dari perlengkapan yang rusak, jadwal yang berubah, hingga peserta yang datang terlambat, namun suasana selalu meriah.</p>
        <p>Pada awal tahun pelajaran, OSIS juga menyelenggarakan MPLS untuk menyambut siswa baru. Persiapannya meliputi penyusunan rangkaian acara, dekorasi ruangan, pengaturan perangkat suara, serta memastikan kegiatan berlangsung tertib. Selain itu, kegiatan keagamaan seperti tadarus bersama dan peringatan hari besar Islam turut dijalankan. Untuk pengembangan kepemimpinan, OSIS mengadakan LDK berisi pelatihan dasar, simulasi, dan praktik kerja sama.</p>
        <p>Berbagai program lain seperti lomba kerajinan tangan, lomba menyanyi lagu nasional, kebersihan kelas, serta kegiatan akademik seperti karya ilmiah remaja juga berada dalam ruang lingkup OSIS. Tugas administratif berupa penyusunan program kerja dan laporan pertanggungjawaban merupakan bagian dari pekerjaan rutin. Rapat OSIS sering berlangsung panjang, namun dari rapat itulah berbagai kegiatan besar direncanakan dan direalisasikan. Banyak kejadian spontan yang justru membuat pengalaman di OSIS semakin berkesan.</p>`,
      },
      {
        title: "PMR (2020–2022)",
        content: `<p>Keterlibatan di PMR dimulai pada tahun 2020 dengan minat untuk mempelajari pertolongan pertama. Latihan intens dilakukan mulai dari pemasangan perban, pembalutan luka, penggunaan tandu, hingga simulasi pengenalan cedera dan penanganan keadaan darurat. Latihan-latihan tersebut tidak selalu berjalan sempurna, namun sangat bermanfaat dalam memahami teknik dasar kesehatan.</p>
        <p>Dalam berbagai acara sekolah, PMR berperan memberikan bantuan tahap awal bagi siswa yang mengalami cedera ringan atau kurang sehat. Penanganan harus dilakukan dengan tenang meskipun situasi kadang muncul secara mendadak. Selain tugas lapangan, PMR juga mengadakan edukasi kesehatan, simulasi keadaan darurat, dan diskusi rutin untuk meningkatkan kemampuan anggota.</p>
        <p>Pengalaman di PMR memberikan pemahaman yang lebih dalam mengenai ketenangan, kepedulian, dan tanggung jawab dalam menangani kondisi orang lain. Kegiatan-kegiatan yang dijalankan membentuk kemampuan menghadapi situasi tak terduga dengan lebih tenang dan terarah.</p>`,
      },
    ],
  },
  "telkom-perkuliahan": {

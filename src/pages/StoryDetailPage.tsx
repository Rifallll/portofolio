...
const allStoriesContent: { [key: string]: { title: string; tags: string[]; postedBy: string; date: string; mainImage: string; paragraphs: string[]; additionalImages?: { src: string; alt: string }[] } } = {
  ...
  "man1-pertemanan": {
    ...
    paragraphs: [
      ...
      `Aktivitas sekolah juga selalu penuh kejutan. Praktikum di lab kimia sering berakhir dengan suara panik yang kemudian berubah menjadi tawa karena racikan kita tidak pernah mirip hasil buku. Festival bahasa membuat kita tampil percaya diri meski latihan selalu kacau. Manasik haji menjadi pengalaman seru karena kita baris rapi di awal, tetapi perlahan melebar seperti formasi burung yang kehilangan arah. Kita juga pernah pergi ke pantai tanpa rencana matang dan pulang dengan cerita yang tidak bisa diceritakan ke guru mana pun. Semua itu menjadi warna yang sulit digantikan.`,
      `Masuk tahun 2021 saat kelas tiga, suasana mulai berubah. Kita mulai menghitung hari. Setiap momen terasa lebih penting dari biasanya. Kita makan di warung Teteh lebih lama, bercanda lebih sering, foto lebih banyak, dan bahkan hal kecil seperti duduk di kelas terasa lebih berarti. Seolah-olah kita diam-diam sepakat untuk menyimpan sebanyak mungkin kenangan sebelum semuanya berakhir.`,
      `Hingga akhirnya datang 2022. Kita duduk bersama di ruang wisuda dengan perasaan campur aduk antara bangga, haru, dan sedikit sedih. Kita saling menatap dan bertanya-tanya dalam hati kapan lagi bisa berkumpul seperti ini. Ruangan itu menjadi saksi terakhir dari perjalanan tiga tahun yang terlalu cepat berlalu.`,
      `Namun satu hal tidak berubah. Persahabatan ini tidak pernah berhenti di tanggal kelulusan. Ia tetap hidup di setiap ingatan tentang tawa, drama kecil, cerita panjang, dan momen absurd yang hanya kita yang mengerti. Semoga langkah setelah tahun 2022 membawa kita ke tempat yang lebih tinggi, tetapi tetap menjaga satu hal yang selalu membuat masa SMA terasa luar biasa: pertemanan yang tidak pernah benar-benar selesai.`,
    ],
    additionalImages: [

...
const storyData = [
  ...
  },
  {
    ...
    imageSrcs: ["/placeholder-story-1.jpg", "/placeholder-story-3.jpg"], // Reusing
  ...
  },
  {
    ...
    imageSrcs: ["/placeholder-story-2.jpg", "/placeholder-story-4.jpg"], // Reusing
  ...
  },
  {
    ...
    imageSrcs: ["/placeholder-story-5.jpg", "/placeholder-story-7.jpg"], // Reusing
  ...
  },
  {
    ...
    imageSrcs: ["/placeholder-story-6.jpg", "/placeholder-story-8.jpg"], // Reusing

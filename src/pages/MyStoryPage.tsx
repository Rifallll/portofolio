...
const storySections = [
  {
    id: "awal-ketertarikan",
    category: "Education Journey",
    title: "Awal Ketertarikan pada Teknologi",
...
const MyStoryPage = () => {
  // Scroll to section if hash exists in URL on load
  useEffect(() => {

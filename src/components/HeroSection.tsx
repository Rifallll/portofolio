...
const HeroSection = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex flex-col items-center justify-center text-center pt-20">
      <h1 className="text-7xl md:text-8xl font-extrabold text-white mb-4">John Doe</h1>
      <p className="text-3xl md:text-4xl text-gray-200 mb-8">Full Stack Developer</p>
      <p className="text-lg text-gray-300 max-w-3xl mb-12 px-4">

...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10 flex flex-col lg:flex-row items-center lg:justify-between max-w-6xl h-full lg:gap-x-12"> {/* Menambahkan gap-x-12 */}
        ...
        <div className="lg:w-[40%] flex justify-center lg:justify-end lg:items-end h-full">
          <img
            ...
            className="max-w-full h-auto lg:max-w-lg xl:max-w-xl object-contain" {/* Ukuran gambar disesuaikan kembali */}
          />
        </div>
      </div>
    </section>

...
const AboutSection = () => {
  return (
    <section id="about" className="py-20 bg-gray-900"> {/* Mengubah bg-white menjadi bg-gray-900 */}
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-12 max-w-5xl mx-auto">
          ...
          <div className="lg:w-2/3 text-left">
            <Card className="p-8 shadow-lg mb-8 bg-gray-800 border-gray-700 text-white"> {/* Menyesuaikan latar belakang dan teks kartu */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="p-6 text-center shadow-sm hover:shadow-md transition-shadow duration-200 bg-gray-800 border-gray-700"> {/* Menyesuaikan latar belakang kartu */}

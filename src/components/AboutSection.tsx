            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="p-6 text-center shadow-sm hover:shadow-md transition-shadow duration-200 bg-card border border-border">
                <CardContent className="flex flex-col items-center p-0">
                  ...
                  <p className="font-semibold text-xl text-foreground">Experience</p>
              ...
              <Card className="p-6 text-center shadow-sm hover:shadow-md transition-shadow duration-200 bg-card border border-border">
                <CardContent className="flex flex-col items-center p-0">
                  ...
                  <p className="font-semibold text-xl text-foreground">Education</p>
              ...
              <Card className="p-6 text-center shadow-sm hover:shadow-md transition-shadow duration-200 bg-card border border-border">
                <CardContent className="flex flex-col items-center p-0">
                  ...
                  <p className="font-semibold text-xl text-foreground">Collaboration</p>

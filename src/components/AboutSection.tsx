      ...
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start mt-12 max-w-6xl mx-auto">
          ...
          <Card className="lg:col-span-1 p-8 shadow-xl hover:shadow-2xl transition-shadow duration-300 flex flex-col items-center text-center bg-card border border-border">
            ...
            />
            <h3 className="text-3xl font-heading text-foreground mb-2">Rifal Azhar Permana</h3>
            <p className="text-xl text-muted-foreground font-body mb-4">Web Developer</p>
            <p className="text-md text-muted-foreground font-body max-w-xs">
          ...
          <div className="lg:col-span-2 flex flex-col gap-8 text-left">
            ...
            <Card className="p-8 shadow-lg bg-card border border-border">
              <CardHeader className="p-0 mb-4">
                <CardTitle className="text-3xl font-heading text-primary">My Story</CardTitle>
              </CardHeader>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="p-6 text-center shadow-sm hover:shadow-md transition-shadow duration-200 bg-card border border-border">
                <CardContent className="flex flex-col items-center p-0">
                  ...
                  <p className="font-heading text-xl text-foreground">Experience</p>
                  <p className="text-muted-foreground font-body">Building Web Solutions</p>
                </CardContent>
              </Card>
              <Card className="p-6 text-center shadow-sm hover:shadow-md transition-shadow duration-200 bg-card border border-border">
                <CardContent className="flex flex-col items-center p-0">
                  <GraduationCap className="h-10 w-10 text-primary mb-3" />
                  <p className="font-heading text-xl text-foreground">Education</p>
                  <p className="text-muted-foreground font-body">Computer Engineering</p>
                </CardContent>
              </Card>
              <Card className="p-6 text-center shadow-sm hover:shadow-md transition-shadow duration-200 bg-card border border-border">
                <CardContent className="flex flex-col items-center p-0">
                  <HeartHandshake className="h-10 w-10 text-primary mb-3" />
                  <p className="font-heading text-xl text-foreground">Collaboration</p>
                  <p className="text-muted-foreground font-body">Teamwork & Innovation</p>
                </CardContent>
              </Card>
            </div>
          </div>

  ...
  return (
    <section id="contact" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center text-left"> {/* Mengubah kembali menjadi items-center */}
          ...
          <Card className="p-8 shadow-lg flex flex-col items-center justify-center"> {/* Menghapus mt-12 */}

  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-20 max-w-screen-lg relative">
        ...
        >
          <Card className="p-6 rounded-xl shadow-lg border border-border bg-card">
            <CardHeader className="pb-4">
              <CardTitle className="text-4xl md:text-5xl font-extrabold text-foreground text-center">
                {title}
              </CardTitle>
            </CardHeader>
            <CardContent>

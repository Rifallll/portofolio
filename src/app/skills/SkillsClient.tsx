        ...
        >
          ...
          <div className="hidden lg:block">
             <a
              ...
              download
              className="flex items-center gap-2 px-6 py-3 rounded-full bg-cyan-500/10 border border-cyan-500/30 text-cyan-400 font-bold hover:bg-cyan-500 hover:text-black transition-all"
            >

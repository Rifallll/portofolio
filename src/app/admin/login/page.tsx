        ...
        <div className="min-h-screen bg-[#020617] flex items-center justify-center p-4 relative overflow-hidden">
            ...
            >
                ...
                <div className="flex flex-col items-center mb-8">
                    <div className="p-4 rounded-full bg-cyan-500/10 border border-cyan-500/30 mb-4">
                ...
                <form onSubmit={handleLogin} className="space-y-6">
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <Input
                                ...
                                className="pl-10 bg-black/50 border-white/10 text-white font-mono"
                                required
                            />
                        </div>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <Input
                                ...
                                placeholder="••••••••"
                                className="pl-10 pr-10 bg-black/50 border-white/10 text-white font-mono"
                                required
                            />
                            <button
                                type="button"
                    ...
                    <Button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-cyan-600 hover:bg-cyan-500 text-white font-bold tracking-widest uppercase h-12 rounded-xl"
                    >
